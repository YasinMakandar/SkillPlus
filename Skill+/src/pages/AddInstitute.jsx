                ...
                <main className="grow">
                    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                        ...
                        <div className="sm:flex sm:justify-between sm:items-center mb-8">
                            {/* Form */}
                            <div className="w-full dark:bg-[#1F2937] mt-14 rounded-lg m-auto max-w-xl bg-[#FFFFFF] shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                <div className=''>

                                <h1 className=" text-center dark:text-white text text-2xl md:text-3xl font-bold mb-2">Add Institute</h1>
                                <hr />
                                </div>
