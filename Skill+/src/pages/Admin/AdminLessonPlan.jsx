...
import { Root, Viewport, Pages, Page, CanvasLayer, CurrentPage, ZoomOut, CurrentZoom, ZoomIn, Outline, OutlineChildItems, OutlineItem,Thumbnail, Thumbnails } from "@fileforge/pdfreader";
...
function AdminLessonPlan(props) {
  ...
  const pdfUrl = getPDFUrl(decodeURIComponent(plan));
          ...
          <div className="px-4  sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-2">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Lesson Plan</h1>
              </div>
              <div></div>
            </div>
            ...
            >
              ...
              <div
                className={`basis-0 grow min-h-0 relative grid transition-all duration-300 ease-in-out ${
              ...
              >
                ...
                <Viewport className="p-4 h-full dark:bg-[#111827] bg-gray-100">
                  <Pages>
